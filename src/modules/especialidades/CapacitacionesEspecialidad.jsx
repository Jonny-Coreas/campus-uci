...
export default function CapacitacionesEspecialidad({
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      if (recurso?.profile_id) {
        q = q.or(`recurso_id.eq.${recurso.profile_id},recurso_id.is.null`);
      }
  ...
  async function addRow(e) {
    ...
    if (impartida === "SI") {
      if (!personalImpartio.trim()) return alert("Falta el personal que impartió la capacitación");
  ...
  async function exportPDF() {
    try {
      ...
      pdf.save(`Capacitaciones_Especialidad_${fecha}.pdf`);
    } catch (e) {
      console.error(e);
  ...
  async function exportExcel() {
    try {
      ...
      ws.mergeCells("A1:Q1");
      ws.getCell("A1").value = "Bitácora Académica de Especialidad";
      ...
      saveAs(
        ...
        `CampusUCI_Capacitaciones_Especialidad_${fecha}.xlsx`,
      );
    } catch (e) {
      console.error(e);
      ...
      <div style={innerStyle}>
        {!embedded && (
          <div style={{ marginBottom: 14 }}>
            ...
            >
              CAPACITACIONES DE ESPECIALIDAD
            </div>
          </div>
        )}
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 4, fontSize: 13 }}>
              {recurso?.nombre
                ...
                : "Bitácora académica por curso/especialidad"}
            </div>
          </div>
          ...
          >
            <Card title="Registro único (Guarda todo)">
              <form onSubmit={addRow} style={{ display: "grid", gap: 12 }}>
                ...
                <label style={fieldWrap}>
                  <span style={miniLabel}>Capacitación impartida</span>
                ...
                <label style={fieldWrap}>
                  <span style={miniLabel}>Personal que impartió capacitación</span>
                  <input
                    value={personalImpartio}
                    onChange={(e) => setPersonalImpartio(e.target.value)}
                    placeholder="Nombre de quien impartió"
                    style={inputStyle}
                  ...
                  <div style={{ display: "grid", gap: 10, maxHeight: 320, overflowY: "auto", paddingRight: 2 }}>
                    {currentParticipantes.map((p, idx) => (
                      <div key={idx} style={participantCard}>
                        ...
                        <label style={fieldWrap}>
                          <span style={miniLabel}>Observaciones del participante</span>
                          <input
            ...
            <Card
              title="Registros (clic para ver resultados anteriores)"
          ...
          <div style={dashboardGrid}>
            <Card title={selectedId ? "Detalle del registro seleccionado" : "Vista previa del registro actual"}>
              <div style={{ display: "grid", gap: 10 }}>
                <div style={miniBox}>
            ...
            <Card title="Resumen general">
              <div style={statsGrid}>
                <div style={miniBox}>
                  <div style={miniLabel}>Total registros</div>
                ...
                >
                  <div style={miniLabel}>% capacitaciones impartidas</div>
            ...
            <Card title="Notas del panel">
              <div style={{ display: "grid", gap: 10, fontSize: 14, color: "#0f172a" }}>
                <div style={noteBox}>
                  <strong>% capacitaciones impartidas:</strong> mide cuántos registros terminaron en “SI”.
                </div>
                <div style={noteBox}>
          ...
          <div style={chartGrid}>
            <Card title="Capacitaciones impartidas (SI vs NO)">
            ...
            <Card title="Registros por servicio">
              <div style={chartBox}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 16 }}>
            <Card title="Temas más registrados">
